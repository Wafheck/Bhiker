...
router.post("/register", async (req, res) => {
  ...
  <div style="font-family: system-ui, sans-serif, Arial; font-size: 16px; background-color: #fff8f1;">
    <div style="max-width: 600px; margin: auto; padding: 16px;">
      <a href="https://bhiker.vercel.app" target="_blank" rel="noopener">
    ...
    <div style="max-width: 600px; margin: auto; padding: 16px;">
      ...
      <p><strong>
        <a style="display: inline-block; text-decoration: none; outline: none; color: #000000; background-color: #f1c40f; padding: 8px 16px; border-radius: 4px;" 
           href="https://bhiker.vercel.app/login" target="_blank" rel="noopener">
          &nbsp;Open BHIKER
        </a>
      </strong></p>
      <p>If you have any questions or need help getting started, our support team is just an email away at support@bhiker.me. We're here to assist you every step of the way!</p>
      <p>Best regards,<br>
